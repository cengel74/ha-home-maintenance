...
`;var ut={};Bt(ut,{actions:()=>xe,add_task:()=>ne,advanced_settings:()=>Ne,all_labels:()=>He,browse_templates:()=>le,cancel:()=>ke,choose_template:()=>pe,clear:()=>ss,complete:()=>Te,confirm_delete:()=>qe,create_from_scratch:()=>he,create_task:()=>ce,days:()=>Se,default:()=>is,delete:()=>we,description:()=>me,done:()=>Xe,due_soon:()=>De,edit:()=>Ae,edit_task:()=>de,export_csv:()=>ts,icon:()=>Oe,import:()=>Ze,import_csv:()=>Je,import_csv_info:()=>Ge,interval:()=>ve,interval_type:()=>_e,interval_value:()=>ge,labels:()=>ze,last_performed:()=>fe,months:()=>Ce,never:()=>Pe,next_due:()=>be,no_results:()=>Ye,no_tasks:()=>je,notify_when_overdue:()=>Ve,ok:()=>Le,overdue:()=>Ie,panel_title:()=>ae,required_field:()=>Qe,save:()=>$e,search_tasks:()=>Me,search_templates:()=>Ue,sort_by:()=>es,status:()=>ye,tag:()=>Re,task_completed:()=>Fe,task_deleted:()=>We,task_saved:()=>Be,tasks:()=>oe,title:()=>ue,today:()=>Ke,weeks:()=>Ee});var ae="Home Maintenance Pro",oe="Tasks",ne="Add Task",le="Browse Templates",ce="Create Task",de="Edit Task",pe="Choose a Template",he="Create from Scratch",ue="Title",me="Description",ve="Interval",ge="Interval Value",_e="Interval Type",fe="Last Performed",be="Next Due",ye="Status",xe="Actions",$e="Save",ke="Cancel",we="Delete",Te="Complete",Ae="Edit",Se="Days",Ee="Weeks",Ce="Months",Ie="Overdue",De="Due Soon",Le="OK",Pe="Never",Ne="Advanced Settings",Re="NFC Tag",Oe="Icon",ze="Labels",Me="Search tasks...",He="All Labels",Ue="Search templates...",je="No maintenance tasks yet. Add a task or browse templates to get started.",qe="Are you sure you want to delete this task?",Be="Task saved successfully.",We="Task deleted.",Fe="Task marked as complete.",Qe="This field is required.",Ke="Today",Je="Import CSV",Ge="Upload a CSV file with the following columns (title is required, others are optional):",Ze="Import",Xe="Done",Ye="No templates match your search.",Ve="Notify when overdue",ts="Export CSV",es="Sort by",ss="Clear",is={panel_title:ae,tasks:oe,add_task:ne,browse_templates:le,create_task:ce,edit_task:de,choose_template:pe,create_from_scratch:he,title:ue,description:me,interval:ve,interval_value:ge,interval_type:_e,last_performed:fe,next_due:be,status:ye,actions:xe,save:$e,cancel:ke,delete:we,complete:Te,edit:Ae,days:Se,weeks:Ee,months:Ce,overdue:Ie,due_soon:De,ok:Le,never:Pe,advanced_settings:Ne,tag:Re,icon:Oe,labels:ze,search_tasks:Me,all_labels:He,search_templates:Ue,no_tasks:je,confirm_delete:qe,task_saved:Be,task_deleted:We,task_completed:Fe,required_field:Qe,today:Ke,import_csv:Je,import_csv_info:Ge,import:Ze,done:Xe,no_results:Ye,notify_when_overdue:Ve,export_csv:ts,sort_by:es,clear:ss};var Ut={en:ut},jt="en";function n(a,e=jt){return(Ut[e]||Ut[jt])[a]||a}var x=class extends y{constructor(){super(...arguments);this.narrow=!1;this._tasks=[];this._labels=[];this._searchQuery="";this._selectedLabels=new Set;this._sortColumn="title";this._sortDirection="asc";this._loading=!0}static get styles(){return[M,k`
        .btn {
          display: inline-flex;
          align-items: center;
          gap: 6px;
    ...
    `}_renderTaskRow(t){let s=this._getStatus(t),i=this._getStatusLabel(s),r=this._getStatusClass(s);return h`
      <div class="task-table-row">
        ...
        <div class="hide-medium task-labels">
          ${t.labels&&t.labels.length>0?t.labels.map(o=>h`<span class="label-chip">${this._getLabelName(o)}</span>`):u}
        </div>
        <div>
    ...
    `}_handleLabelsInput(t){let s=t.target.value;this._labels=s.split(",").map(i=>i.trim()).filter(i=>i.length>0)}};p([b({attribute:!1})],f.prototype,"hass",2),p([b({type:Boolean})],f.prototype,"narrow",2),p([b({type:String})],f.prototype,"taskId",2),p([b({attribute:!1})],f.prototype,"templateData",2),p([m()],f.prototype,"_title",2),p([m()],f.prototype,"_description",2),p([m()],f.prototype,"_intervalValue",2),p([m()],f.prototype,"_intervalType",2),p([m()],f.prototype,"_lastPerformed",2),p([m()],f.prototype,"_tagId",2),p([m()],f.prototype,"_icon",2),p([m()],f.prototype,"_labels",2),p([m()],f.prototype,"_notifyWhenOverdue",2),p([m()],f.prototype,"_loading",2),p([m()],f.prototype,"_showAdvanced",2),p([m()],f.prototype,"_tags",2),f=p([I("task-form-view")],f);var $=class extends y{constructor(){super(...arguments);this.narrow=!1;this._templates=[];this._searchQuery="";this._expandedCategories=new Set;this._importPreview=[];this._showImportDialog=!1;this._importing=!1;this._importResult=""}static get styles(){return[M,k`
        .btn {
          padding: 8px 16px;
          border-radius: 4px;
          border: 1px solid var(--divider-color);
...
`),c=new Blob([o],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(c),v=document.createElement("a");v.href=l,v.download="home_maintenance_tasks.csv",v.click(),URL.revokeObjectURL(l)}_goBack(){this.dispatchEvent(new CustomEvent("navigate-to-list",{bubbles:!0,composed:!0}))}_onSearchInput(t){this._searchQuery=t.target.value}render(){let t=this._getFilteredTemplates(),s=this._groupByCategory(t),i=Object.keys(s).length>0;return h`
    ...
    `}};p([b({attribute:!1})],$.prototype,"hass",2),p([b({type:Boolean})],$.prototype,"narrow",2),p([m()],$.prototype,"_templates",2),p([m()],$.prototype,"_searchQuery",2),p([m()],$.prototype,"_expandedCategories",2),p([m()],$.prototype,"_importPreview",2),p([m()],$.prototype,"_showImportDialog",2),p([m()],$.prototype,"_importing",2),p([m()],$.prototype,"_importResult",2),$=p([I("template-picker-view")],$);var w=class extends y{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._currentView="list";this._editTaskId=null;this._templateData=null}static get styles(){return k`
      :host {
        display: block;
      }
    `}connectedCallback(){super.connectedCallback(),console.info(`%c ha-home-maintenance %c ${Lt} `,"color: white; background: #3498db; font-weight: bold;","color: #3498db; background: white; font-weight: bold;")}_onNavigateToCreate(){this._currentView="create",this._editTaskId=null,this._templateData=null}_onNavigateToEdit(t){this._currentView="edit",this._editTaskId=t.detail.taskId}_onNavigateToTemplates(){this._currentView="templates"}_onNavigateToList(){this._currentView="list"}_onSelectTemplate(t){this._currentView="create",this._templateData=t.detail.template}render(){switch(this._currentView){case"list":return h`
        ...
        `;case"templates":return h`
          <template-picker-view
            ...
            @navigate-to-list=${this._onNavigateToList}
          ></template-picker-view>
        `}}};p([b({attribute:!1})],w.prototype,"hass",2),p([b({type:Boolean})],w.prototype,"narrow",2),p([b({attribute:!1})],w.prototype,"panel",2),p([m()],w.prototype,"_currentView",2),p([m()],w.prototype,"_editTaskId",2),p([m()],w.prototype,"_templateData",2),w=p([I("ha-home-maintenance-panel")],w);export{w as HaHomeMaintenancePanel};
